...
class TblExpSeedsSerializer(serializers.ModelSerializer):
    class Meta:
        model = TblExpSeeds
        fields = "__all__"
    ...
    def to_representation(self, instance):
        ...
        if is_singular:
            ...
            labels = {
                "field_5070": getattr(instance.field_5070, 'label', None),
            }
            return {
                "values": values,
                "labels": labels,
