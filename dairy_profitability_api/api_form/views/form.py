...
from ..models import TblForm, TblFormField
from ..serializers import TblFormSerializer
...
class TblFormView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            queryset = TblForm.objects.all().order_by("order_by")
            data = TblFormSerializer(queryset, many=True).data
