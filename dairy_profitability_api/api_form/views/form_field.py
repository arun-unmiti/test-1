...
from ..models import TblFormField
from ..serializers import TblFormFieldSerializer
...
class TblFormFieldView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            queryset = TblFormField.objects.filter(form_id=form_id, status=1).order_by("order_by")
            data = TblFormFieldSerializer(queryset, many=True).data
            ...
            return Response({"success": 0, "message": "Server side error, please check GET /form/fields", "desc": str(e)}, status=500)
