...
from leaky_bucket_api.settings import SECRET_KEY, MEDIA_ROOT
import jwt
from jwt.exceptions import ExpiredSignatureError, InvalidTokenError
from django.utils.timezone import now, datetime, timedelta
from ..utils import is_password_valid, send_password_reset_email
        ...
        try:
            ...
            if purpose == "change_profile_image":
                ...
                if profile_image.size > 2 * 1024 * 1024:
                    return Response({"success": 0, "message": "File size exceeds limit of 2 MB, please choose a smaller image"}, status=413)
